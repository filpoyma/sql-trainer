export const CONTENT = {
  ...
  runBtn: {ru: 'Поехали', gb: 'Run'},
  nextBtn: {ru: 'Далее', gb: 'Next'},
  phTextArea: {ru: 'SQL запрос...', gb: 'SQL request...'},
  correct: {ru: 'верно', gb: 'correct'},
  incorrect: {ru: 'неверно', gb: 'incorrect'},
  topic: {ru: 'тема', gb: 'topic'},
};